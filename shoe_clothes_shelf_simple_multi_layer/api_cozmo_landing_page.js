$("#formInfo").submit(function (event) {
  ...
  // var sheetDBData = {
  //   name: "shoe_clothes_shelf_simple_multi_layer",
  ...
  //         value: 10,
  //         currency: "USD",
  //         content_name: "shoe_clothes_shelf_simple_multi_layer",
  ...
  $.ajax({
    ...
    data: {
      ...
      adresse: adresse,
      id_product: "1120",
      name_product: "shoe_clothes_shelf_simple_multi_layer",
      unit_price: "199",
      quantite: "1",
      variant: "",
    ...
    success: function (response) {
      ...
      document.location.href =
        "/shoe_clothes_shelf_simple_multi_layer/order_success.html";
